  ...
  return (
    <div className='bg-white rounded-lg shadow-sm border p-6'>
      <div className='flex items-center justify-between mb-4'>
        ...
        <div
          className={`text-2xl font-bold ${getProgressTextColor(data.overallProgress)}`}
        >
      ...
      <div className='mb-6'>
        <div className='flex justify-between text-sm text-gray-600 mb-2'>
          ...
          <span>
            {data.completedAssignments} de {data.totalAssignments} tareas
          </span>
        </div>
          ...
          data.courses.map(course => (
            ...
            >
              ...
              <div className='ml-4 text-right'>
                <div
                  className={`text-sm font-semibold ${getProgressTextColor(course.progressPercent)}`}
                >
