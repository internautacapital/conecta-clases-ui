    ...
    <div className="w-full">
      ...
      <div className="block sm:hidden space-y-3">
        {data.length === 0 ? (
          ...
          data.map((s) => (
            <div key={s.userId} className="bg-white border rounded-lg p-4 space-y-3">
        ...
        <Table>
          ...
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-48 sm:w-56 text-xs sm:text-sm">% Avance</TableHead>
              <TableHead className="text-xs sm:text-sm">Promedio</TableHead>
              <TableHead className="text-xs sm:text-sm">Última entrega</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {data.length === 0 && (
              ...
              <TableRow key={s.userId}>
                ...
                <TableCell>
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <span className="tabular-nums text-xs sm:text-sm text-muted-foreground">{s.progressPct}%</span>
                  </div>
                </TableCell>
